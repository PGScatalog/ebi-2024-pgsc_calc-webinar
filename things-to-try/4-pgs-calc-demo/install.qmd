...
An understanding of what polygenic scores (PGS) are, why they're useful, and the PGS Catalog would be helpful before starting this tutorial. `(ADD LINKS HERE)`
